...
${DISTDIR}/ADC_set_point.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	...
	@${MP_JAVA_PATH}java -jar "C:/Program Files/Microchip/MPLABX/v6.00/mplab_platform/platform/../mplab_ide/modules/../../bin/checksum.jar" -i PIC18F4550 ${DISTDIR}/ADC_set_point.X.${IMAGE_TYPE}.hex 2> NUL 1> NUL
